...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--adjust_relighting',action='store_true', help='whether to use adjust relighting')

        self.parser.add_argument('--left_one_out',action='store_true', help='whether to use one fr to test generalization')
        self.parser.add_argument('--natural_initial_lighting',action='store_true', help='whether to use natural initialization of relighting')
        self.parser.add_argument('--adapt_iter',action='store_true',help='whether to adaptly adjust the attack iteration')

        self.parser.add_argument('--hard_constrain_sh',action='store_true',help='whether to hard constrain the sh parameters')
        self.parser.add_argument('--relighting_dist_constraint',action='store_true',help='whether to soft constrain the sh parameters')
        #setting for simswap
